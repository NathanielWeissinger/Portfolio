...
public class ListTester {
    ...
    private void runTests() {
        ...
        //1-element to empty list
            //FIRST LIST TEST
        testEmptyList(A_removeA_emptySet, "A_removeA_emptySet");
            //SECOND ARRAY TEST
        testEmptyList(A_removeLast_emptySet, "A_removeLast_emptySet");
            //THIRD ARRAY TEST
        testEmptyList(A_remove0_emptySet, "A_remove0_emptySet");
        //1-element to 2-element
        testTwoElementList(A_addToFrontB_BA, "A_addToFrontB_BA", LIST_BA, STRING_BA);
            //THIRD SLL TEST
        testTwoElementList(B_addToRearA_BA, "B_addToRearA_BA", LIST_BA, STRING_BA);
            //FOURTH SLL TEST
        testTwoElementList(B_add1A_BA, "B_add1A_BA", LIST_BA, STRING_BA);
            //SECOND LIST TEST
        testTwoElementList(B_addA_BA, "B_addA_BA", LIST_BA, STRING_BA);
            //THIRD LIST TEST
        testTwoElementList(B_addAfterA_B_BA, "B_addAfterA_B_BA", LIST_BA, STRING_BA);
        ...
        //2-element to changed 2-element via set()
            //SIXTH LIST TEST
        testTwoElementList(CA_set0B_BA, "CA_set0B_BA", LIST_BA, STRING_BA);
        //3-element to 2-element
            //SEVENTH LIST TEST
        testTwoElementList(BAC_removeLast_BA, "BAC_removeLast_BA", LIST_BA, STRING_BA);
            //FIFTH ARRAY TEST
        testThreeElementList(ADC_set1B_ABC, "ADC_set1B_ABC", LIST_ABC, STRING_ABC);
            //SIXTH ARRAY TEST
        testThreeElementList(AC_addAfterBA_ABC, "AC_addAfterBA_ABC", LIST_ABC, STRING_ABC);
            //SEVENTH ARRAY TEST
        testThreeElementList(ABCD_removeD_ABC, "ABCD_removeD_ABC", LIST_ABC, STRING_ABC);
            //FIFTH SLL TEST
        testThreeElementList(BC_add0A_ABC, "BC_add0A_ABC", LIST_ABC, STRING_ABC);
            //SIXTH SLL TEST
...
//          break;
     ...
     */
    private IndexedUnsortedList<Integer> A_removeA_emptySet() {
        IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
        list.remove(ELEMENT_A);
        return list;
    }
    private Scenario<Integer> A_removeA_emptySet = () -> A_removeA_emptySet();
    
    /** Scenario: [A] -> remove(0) -> empty list 
     * @return [A] after remove(0)
     */
    private IndexedUnsortedList<Integer> A_remove0_emptySet() {
        IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
        list.remove(0);
        return list;
    }
    private Scenario<Integer> A_remove0_emptySet = () -> A_remove0_emptySet();
    
    /** Scenario: [A] -> removeLast() -> empty list 
     * @return [A] after removeLast()
     */
    private IndexedUnsortedList<Integer> A_removeLast_emptySet() {
        IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
        list.removeLast();
        return list;
    }
    private Scenario<Integer> A_removeLast_emptySet = () -> A_removeLast_emptySet();
    ...
    /** Scenario: [B] -> add(1,A) -> [B,A] 
     * @return [B,A] after add(1,A)
     */
    private IndexedUnsortedList<Integer> B_add1A_BA() {
        IndexedUnsortedList<Integer> list = newList(); 
        list.addToFront(ELEMENT_B);
        list.add(1,ELEMENT_A);
        return list;
    }
    private Scenario<Integer> B_add1A_BA = () -> B_add1A_BA();
    ...
    /** Scenario: [B] -> add(A) -> [B,A] 
     * @return throws no exception
     */
    private IndexedUnsortedList<Integer> B_addA_BA() {
        IndexedUnsortedList<Integer> list = newList();
        list.addToFront(ELEMENT_B);
        list.add(ELEMENT_A);
        return list;
    }
    private Scenario<Integer> B_addA_BA = () -> B_addA_BA();
    
    /** Scenario: [B] -> addToRear(A) -> [B,A] 
     * @return throws no exception
     */
    ...
    /** Scenario: [B] -> addAfter(B,A) -> [B,A] 
     * @return throws no exception
     */
    private IndexedUnsortedList<Integer> B_addAfterA_B_BA() {
        IndexedUnsortedList<Integer> list = newList();
        list.addToFront(ELEMENT_B);
        list.addAfter(ELEMENT_A, ELEMENT_B);
        return list;
    }
    private Scenario<Integer> B_addAfterA_B_BA = () -> B_addAfterA_B_BA();
     ...
     * @return throws no exception
     */
    private IndexedUnsortedList<Integer> CA_set0B_BA() {
        IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
        list.addToFront(ELEMENT_C);
        list.set(0,ELEMENT_B);
        return list;
    }
    private Scenario<Integer> CA_set0B_BA = () -> CA_set0B_BA();
    
    /** Scenario: [A,D,C] -> set(1,B) -> [A,B,C] 
     * @return throws no exception
     */
    private IndexedUnsortedList<Integer> ADC_set1B_ABC() {
        IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
    ...
    private Scenario<Integer> ADC_set1B_ABC = () -> ADC_set1B_ABC();
    
    /** Scenario: [A,C] -> addAfter(B,A) -> [A,B,C] 
     * @return throws no exception
     */
    private IndexedUnsortedList<Integer> AC_addAfterBA_ABC() {
        IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
        list.addToRear(ELEMENT_C);
        list.addAfter(ELEMENT_B,ELEMENT_A);
        return list;
    }
    private Scenario<Integer> AC_addAfterBA_ABC = () -> AC_addAfterBA_ABC();
    
    /** Scenario: [B,C] -> add(0,A) -> [A,B,C] 
     * @return throws no exception
     */
    private IndexedUnsortedList<Integer> BC_add0A_ABC() {
        IndexedUnsortedList<Integer> list = newList();
    ...
    private Scenario<Integer> BC_add0A_ABC = () -> BC_add0A_ABC();
    ...
    /** Scenario: [A,B,C,D] -> remove(D) -> [A,B,C] 
     * @return throws no exception
     */
    private IndexedUnsortedList<Integer> ABCD_removeD_ABC() {
        IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
        list.addToRear(ELEMENT_B);
        list.addToRear(ELEMENT_C);
        list.addToRear(ELEMENT_D);
    ...
    private Scenario<Integer> ABCD_removeD_ABC = () -> ABCD_removeD_ABC();
